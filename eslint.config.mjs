...
//comentário de tipagem que informa ao TS e ao VSCode qual o tipo de dado que a variável a seguir deve ter
...
export default [
  ...
  pluginReact.configs.flat.recommended,
  {
    ...
    settings: {
      react: {
        version: 'detect' // o eslint detecta automaticamente a versão do react
      }
    },
    plugins: {
      react: pluginReact,
    ...
    rules: {
      ...
      'react/react-in-jsx-scope': 'off', // quando está ligado nos obriga a importar o react
